    ...
    <div class="card-component">
        <div class="row mb-2">
            ...
            <div class="col-md-4">
                ...
                <select class="form-select" name="compositions[0][category_id]" id="composition_category_id">
            ...
            <div class="col-md-4">
                ...
                <select class="form-select" name="compositions[0][articulo_id]" id="composition_articulo_id">
