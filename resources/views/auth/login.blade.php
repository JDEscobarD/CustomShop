...
<div class="container">
    <div class="row align-items-center mt-5">
        <div class="col-lg-4 offset-lg-1">
            <section class="login">
                <img src="{{ asset('media/images/CUSTOMSHOP-PRO-logo.svg') }}" alt="CustomShop PRO">
                <!--Controles de logueo-->
                <form action="" method="POST">
                    ...
                    <div class="btn-section">
                        <a href="{{ route('dashboard') }}" class="btn btn-primary d-block w-100">Iniciar sesión</a>
                ...
                <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="10000">
                            <img src="{{ asset('media/images/img-carousel-01.png') }}" class="d-block w-100" alt="...">
                        ...
                        <div class="carousel-item" data-bs-interval="10000">
                            <img src="{{ asset('media/images/img-carousel-02.png') }}" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class="carousel-item" data-bs-interval="10000">
                            <img src="{{ asset('media/images/img-carousel-03.png') }}" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
